      ...
      <div className="relative w-full px-6">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-12">
            <button className="bg-white text-gray-800 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg whitespace-nowrap cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-gray-200 text-sm">Get contacted directly by customers and procurement teams</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-gray-200 text-sm">Appear first on homepage and in all search results</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <h3 className="text-lg font-semibold mb-2">Special Verification</h3>
              <p className="text-gray-200 text-sm">Get verified badge and recommended supplier status</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-gray-200 text-sm">Real-time leads alerts and comprehensive business insights</p>
            </div>
          </div>
