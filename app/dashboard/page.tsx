      ...
      <main className="py-8 flex-grow">
        <div className="w-full px-6">
          <div className="max-w-7xl mx-auto">
            {/* Profile Header */}
            <div className="bg-white rounded-2xl shadow-sm p-8 mb-8 border border-gray-100 relative overflow-hidden">
                    ...
                    <div className="flex items-center space-x-6">
                      <div className="relative">
                        <img
                          ...
                          src="https://readdy.ai/api/search-image?query=Professional%20middle%20eastern%20businessman%20portrait%2C%20clean%20background%2C%20modern%20business%20attire%2C%20confident%20smile%2C%20professional%20headshot%20style&width=100&height=100&seq=user-avatar&orientation=squarish"
                        />
                        <button
                          onClick={() => setShowPhotoUpload(true)}
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mb-2">Metro Electronics Supply</p>
