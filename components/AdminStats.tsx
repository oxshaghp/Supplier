...
export default function AdminStats() {
  ...
  const recentActivities = [
    ...
    {
      type: 'payment',
      message: 'Premium subscription payment received from Metro Electronics',
      time: '12 minutes ago',
    ...
    {
      type: 'content_report',
      message: 'Content reported: Inappropriate business description',
      time: '25 minutes ago',
      icon: 'ri-flag-line',
    ...
    {
      type: 'employee',
      message: 'New employee added: Sarah Johnson (Content Moderator)',
      time: '2 hours ago',
      icon: 'ri-team-line',
  ...
  const quickActions = [
    {
      ...
      description: 'Create new employee account with permissions',
      icon: 'ri-user-add-line',
      color: 'bg-blue-500'
    },
    {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h3 className="text-lg font-semibold text-gray-800 mb-6">System Health Monitor</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-yellow-600 font-medium">Protected</p>
          </div>
        </div>
      </div>
    </div>
