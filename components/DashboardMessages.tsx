...
export default function DashboardMessages({ selectedMessageId }) {
    ...
    inbox: [
      {
        ...
        message: 'Hi, I am interested in placing a bulk order for LED TVs. We need approximately 50 units for our office setup. Could you please provide pricing and availability? We are looking for Samsung or LG models, 43-55 inch range.',
        time: '2 hours ago',
        unread: true,
        type: 'inquiry',
      ...
      },
      {
        ...
        message: 'You have received a new 5-star review from a customer! The review has been approved by our admin team and is now live on your business profile. The customer praised your excellent service and fast delivery.',
        time: '4 hours ago',
        unread: true,
        type: 'notification',
      ...
      },
      {
        ...
        message: 'We are expanding our electronics section and would like to discuss a potential partnership. Are you interested in setting up a retail presence in our mall? Please let me know your thoughts.',
        time: '5 hours ago',
        unread: true,
        type: 'business',
      ...
      },
      {
        ...
        message: 'A customer has left a 4-star review for your business. They appreciated your quality products and service. The review mentions: "Good quality products and reasonable prices. Professional service throughout."',
        time: '1 day ago',
        unread: false,
        type: 'notification',
        contact: 'noreply@platform.com',
      ...
      },
      {
        ...
        message: 'We need a quote for gaming computers and accessories. Our requirements include 20 high-end gaming PCs, mechanical keyboards, gaming mice, and monitors. Timeline is flexible.',
        time: '2 days ago',
        unread: false,
        type: 'quote',
      ...
      },
      {
        ...
        message: 'Our startup is setting up a new office and we need various electronic equipment. Looking for laptops, printers, networking equipment, and audio/video conferencing setup.',
        time: '3 days ago',
        unread: false,
        type: 'inquiry',
    ...
    sent: [
      {
        ...
        message: 'Thank you for your inquiry. Please find attached our latest price list for electronic components. We offer bulk discounts for orders over $10,000. Let me know if you need any specific information.',
        time: '3 hours ago',
        type: 'response'
      },
      {
        ...
        message: 'The Samsung TV models you requested are now back in stock. We have 25 units of the 50" model and 15 units of the 55" model available. Please confirm your order by end of week.',
        time: '1 day ago',
        type: 'update'
      }
    ]
  ...
  useEffect(() => {
    if (selectedMessageId) {
      const message = messages.inbox.find(m => m.id === selectedMessageId) ||
                     messages.sent.find(m => m.id === selectedMessageId);
      ...
      if (message) {
        ...
        if (messages.sent.find(m => m.id === selectedMessageId)) {
          setActiveTab('sent');
        }
      }
    }
  ...
  const getMessageIcon = (type) => {
    switch (type) {
      case 'inquiry': return 'ri-question-line';
      case 'business': return 'ri-briefcase-line';
      case 'quote': return 'ri-file-text-line';
      case 'response': return 'ri-reply-line';
  ...
  const getMessageColor = (type) => {
    switch (type) {
      ...
      case 'quote': return 'bg-yellow-100 text-yellow-600';
      case 'response': return 'bg-purple-100 text-purple-600';
      case 'update': return 'bg-orange-100 text-orange-600';
      case 'notification': return 'bg-pink-100 text-pink-600';
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="bg-yellow-400 text-white px-6 py-3 rounded-lg hover:bg-yellow-500 font-medium whitespace-nowrap cursor-pointer">
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-screen overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${getMessageColor(selectedMessage.type)}`}>
                    <i className={`${getMessageIcon(selectedMessage.type)} text-sm`}></i>
                  </div>
                  <div>
            ...
            <div className="p-6">
              <div className="mb-6">
                <h2 className="text-lg font-semibold text-gray-800 mb-2">{selectedMessage.subject}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-800">{messages.inbox.filter(m => m.unread).length}</h3>
