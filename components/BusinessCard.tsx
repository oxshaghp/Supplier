          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-48 h-32 md:h-auto relative overflow-hidden rounded-lg flex-shrink-0">
              ...
              <div className="absolute top-2 right-2 bg-white rounded-full px-2 py-1 shadow-md">
                <span className="text-xs font-medium text-gray-700">{business.distance}</span>
              </div>
              {business.verified && (
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 flex-1">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className={`${getBusinessTypeColor(business.businessType)} px-2 py-1 rounded-full flex items-center space-x-1`}>
                      <i className={`${getBusinessTypeIcon(business.businessType)} text-xs`}></i>
                  ...
                  <p className="text-yellow-600 font-medium text-sm mb-3">{business.category}</p>
                ...
                <div className="flex flex-row md:flex-col gap-2 md:w-32 md:self-end md:mt-auto">
                  ...
                  <Link href={`/business/${business.id}`} className="flex-1 md:w-full border border-yellow-400 text-yellow-600 py-2 px-3 rounded-lg hover:bg-yellow-50 font-medium text-xs whitespace-nowrap cursor-pointer text-center">
                    View Profile
                  </Link>
                </div>
              </div>
