...
export default function BusinessFilters({
  ...
  const categories = [
    { id: 'all', name: 'All Categories', icon: 'ri-apps-2-line' },
    ...
    { id: 'brass-hardware', name: 'Brass Hardware & Components', icon: 'ri-tools-line' },
    { id: 'business-services', name: 'Business Services', icon: 'ri-briefcase-line' },
    { id: 'chemicals', name: 'Chemicals', icon: 'ri-flask-line' },
    { id: 'computer-hardware-software', name: 'Computer Hardware & Software', icon: 'ri-computer-line' },
    { id: 'construction-real-estate', name: 'Construction & Real Estate', icon: 'ri-hammer-line' },
    { id: 'consumer-electronics', name: 'Consumer Electronics', icon: 'ri-smartphone-line' },
    { id: 'electronics-electrical', name: 'Electronics & Electrical Supplies', icon: 'ri-flashlight-line' },
    { id: 'energy-power', name: 'Energy & Power', icon: 'ri-lightning-line' },
    { id: 'environment-pollution', name: 'Environment & Pollution', icon: 'ri-leaf-line' },
    { id: 'food-beverage', name: 'Food & Beverage', icon: 'ri-restaurant-line' },
    ...
    { id: 'home-textiles', name: 'Home Textiles & Furnishings', icon: 'ri-shirt-line' },
    { id: 'hospital-medical', name: 'Hospital & Medical Supplies', icon: 'ri-health-book-line' },
    { id: 'hotel-supplies', name: 'Hotel Supplies & Equipment', icon: 'ri-hotel-line' },
    { id: 'industrial-supplies', name: 'Industrial Supplies', icon: 'ri-settings-line' },
    { id: 'jewelry-gemstones', name: 'Jewelry & Gemstones', icon: 'ri-gem-line' },
    { id: 'leather-products', name: 'Leather & Leather Products', icon: 'ri-handbag-line' },
    { id: 'machinery', name: 'Machinery', icon: 'ri-settings-2-line' },
    { id: 'mineral-metals', name: 'Mineral & Metals', icon: 'ri-copper-diamond-line' },
    { id: 'office-school', name: 'Office & School Supplies', icon: 'ri-book-line' },
    ...
    { id: 'pipes-tubes', name: 'Pipes, Tubes & Fittings', icon: 'ri-roadster-line' },
    { id: 'plastics-products', name: 'Plastics & Products', icon: 'ri-recycle-line' },
    { id: 'printing-publishing', name: 'Printing & Publishing', icon: 'ri-printer-line' },
    { id: 'real-estate', name: 'Real Estate', icon: 'ri-building-line' },
    { id: 'scientific-laboratory', name: 'Scientific & Laboratory Instruments', icon: 'ri-microscope-line' },
    { id: 'security-protection', name: 'Security & Protection', icon: 'ri-shield-line' },
    { id: 'sports-entertainment', name: 'Sports & Entertainment', icon: 'ri-football-line' },
    { id: 'telecommunications', name: 'Telecommunications', icon: 'ri-phone-line' },
    { id: 'textiles-fabrics', name: 'Textiles & Fabrics', icon: 'ri-shirt-line' },
    { id: 'toys', name: 'Toys', icon: 'ri-gamepad-line' },
    { id: 'transportation', name: 'Transportation', icon: 'ri-truck-line' }
  ];

  const businessTypes = [
    { id: 'all', name: 'All Types', icon: 'ri-building-line' },
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Business Types */}
      <div className="bg-white rounded-2xl shadow-lg p-6">
        <h3 className="text-lg font-semibold mb-4 text-gray-800">Business Type</h3>
