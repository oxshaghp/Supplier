export const translations = {
  en: {
    ...
    completeProfile: {
      ...
      accountVerified: "Account Information (Verified)",
      business: "Business",
      phone: "Phone",
      email: "Email",
      ...
      steps: {
        ...
        "hoursB branches": "Working Hours & Branches",
        verification: "Document Verification",
      },

      step1: {
        businessTypeLabel: "What is your business type",
        categoriesLabel: "Business Categories",
        categoriesDesc:
          "Select all categories that apply to your business. This helps customers find you more easily.",
        ...
        searchMatchingDesc:
          'When customers search for "LED TV" or "office chairs", your business will appear if you include these keywords',
        beSpecific: "Be Specific",
        beSpecificDesc:
          'Use exact product names: "iPhone 15", "Samsung TV", "wooden dining table" instead of just "electronics"',
        thinkLikeCustomers: "Think Like Customers",
        thinkLikeCustomersDesc:
          'Add terms customers actually search for: "cheap laptops", "bulk printing", "emergency repair"',
        proTip:
          "Pro Tip: Add 15-30 keywords including product names, brands, services, and customer search terms",
        keywordsPlaceholder:
          "Enter products and services separated by commas. Example: LED TV, Samsung electronics, iPhone repair, laptop wholesale...",
        keywordsCount: "{count} keywords added (recommended: 15-30)",
        goodLength: "✓ Good",
        minChars: "{count}/20 chars",
      ...
      step2: {
        ...
        serviceDistancePlaceholder: "How far do you serve?",
        servicesLabel: "Services Offered (Optional)",
        servicesDesc: "Select all services that apply to your business",
      },

      step3: {
        websiteLabel: "Website (Optional)",
        mainPhoneLabel: "Main Business Phone",
        mainPhoneDesc: "Primary contact number for your business",
        additionalPhones: "Additional Contact Numbers (Optional)",
        additionalPhonesDesc:
          "Add specialized contact numbers for different departments",
        addNumber: "Add Number",
        contactName: "Contact name",
        noAdditionalNumbers: "No additional numbers added",
        addContactNumber: "Add Contact Number",
        addressLabel: "Business Address",
        addressPlaceholder: "Enter your complete business address",
        selectedLocation: "Selected Location: Lat {lat}, Lng {lng}",
        locationHelp:
      ...
      step4: {
        ...
        closed: "Closed",
        to: "to",
        multipleBranchesTitle: "Multiple Branches",
        multipleBranchesDesc:
          "Expand your business reach with multiple locations",
        multipleLocations: "Multiple Locations",
        multipleLocationsDesc: "Serve customers across different areas",
        flexibleHours: "Flexible Hours",
        flexibleHoursDesc: "Different hours per branch",
        betterManagement: "Better Management",
        betterManagementDesc: "Track each location performance",
        readyToAdd: "Ready to add branches?",
        skipStep: "Skip this step and add branches later",
        addBranches: "Add Branches",
        yourBranches: "Your Branches ({count})",
        moreBranches: "+{count} more branches",
        manageBranches: "Manage Branches",
        benefitsTitle: "Branch Management Benefits",
      ...
      step5: {
        verificationTitle: "Business Verification Required",
        verificationDesc:
        ...
        targetCustomers: "Target Customers",
        targetCustomersTypes: "{count} types",
        keywords: "Keywords",
        keywordsAdded: "{count} added",
      },
      ...
      modals: {
        ...
        verificationTitle: "Profile Submitted Successfully!",
        verificationDesc:
        ...
        verify1: "Document verification by our team",
        verify2: "Business information validation",
        verify3: "Email notification of approval status",
        verify4: "Profile goes live once verified",
        viewProfile: "View Profile",
        close: "Close",
      },
      ...
      phoneTypes: {
        ...
        procurement: "Procurement Representative",
      ...
      errors: {
        invalidFile: "Please upload a valid file (JPG, PNG, or PDF)",
  ...
  ar: {
    ...
    // Complete Profile
    completeProfile: {
      title: "أكمل ملفك التعريفي",
      stepOf: "الخطوة {current} من {total}",
      accountVerified: "معلومات الحساب (موثقة)",
      business: "النشاط",
      phone: "الهاتف",
      email: "البريد",
      ...
      step1: {
        businessTypeLabel: "ما هو نوع نشاطك التجاري",
        categoriesLabel: "فئات النشاط",
        categoriesDesc:
          "اختر جميع الفئات التي تنطبق على نشاطك. هذا يساعد العملاء في إيجادك بسهولة.",
        categoriesSelected: "{count} فئات محددة",
        clearAll: "مسح الكل",
        selectedCategories: "الفئات المحددة:",
        keywordsTitle: "كلمات المنتجات والخدمات",
        howToOptimize: "كيف تحسّن؟",
        searchMatching: "مطابقة البحث",
        searchMatchingDesc:
          'عندما يبحث العملاء عن "تلفزيون LED" أو "كراسي مكتب"، سيظهر نشاطك إذا أضفت هذه الكلمات',
        beSpecific: "كن محدداً",
        beSpecificDesc:
          'استخدم أسماء المنتجات الدقيقة: "آيفون 15"، "تلفزيون سامسونج"، "طاولة طعام خشبية" بدلاً من "إلكترونيات" فقط',
        thinkLikeCustomers: "فكر كالعملاء",
        thinkLikeCustomersDesc:
          'أضف المصطلحات التي يبحث عنها العملاء فعلياً: "لابتوب رخيص"، "طباعة بالجملة"، "إصلاح طوارئ"',
        proTip:
          "نصيحة: أضف 15-30 كلمة تشمل أسماء المنتجات والعلامات التجارية والخدمات ومصطلحات البحث",
        keywordsPlaceholder:
          "أدخل المنتجات والخدمات مفصولة بفاصلة. مثال: تلفزيون LED، إلكترونيات سامسونج، إصلاح آيفون، لابتوب بالجملة...",
        keywordsCount: "{count} كلمة مضافة (الموصى به: 15-30)",
        goodLength: "✓ جيد",
        minChars: "{count}/20 حرف",
      ...
      step2: {
        ...
        serviceDistancePlaceholder: "ما المسافة التي تخدمها؟",
        servicesLabel: "الخدمات المقدمة (اختياري)",
        servicesDesc: "اختر جميع الخدمات التي تنطبق على نشاطك",
      },

      step3: {
        websiteLabel: "الموقع الإلكتروني (اختياري)",
        mainPhoneLabel: "الهاتف الرئيسي للنشاط",
        mainPhoneDesc: "رقم الاتصال الأساسي لنشاطك",
        additionalPhones: "أرقام اتصال إضافية (اختياري)",
        additionalPhonesDesc: "أضف أرقام متخصصة لأقسام مختلفة",
        addNumber: "إضافة رقم",
        contactName: "اسم جهة الاتصال",
        noAdditionalNumbers: "لم تتم إضافة أرقام إضافية",
        addContactNumber: "إضافة رقم اتصال",
        addressLabel: "عنوان النشاط",
        addressPlaceholder: "أدخل عنوان نشاطك الكامل",
        selectedLocation: "الموقع المحدد: خط العرض {lat}، خط الطول {lng}",
        locationHelp: "انقر على الخريطة لضبط دبوس موقع نشاطك بدقة",
      },

      step4: {
        workingHoursTitle: "ساعات العمل",
        workingHoursDesc: "حدد ساعات عمل نشاطك الرئيسية",
        closed: "مغلق",
        to: "إلى",
        multipleBranchesTitle: "فروع متعددة",
        multipleBranchesDesc: "وسّع نطاق نشاطك بمواقع متعددة",
        multipleLocations: "مواقع متعددة",
        multipleLocationsDesc: "خدم العملاء في مناطق مختلفة",
        flexibleHours: "ساعات مرنة",
        flexibleHoursDesc: "ساعات مختلفة لكل فرع",
        betterManagement: "إدارة أفضل",
        betterManagementDesc: "تتبع أداء كل موقع",
        readyToAdd: "جاهز لإضافة فروع؟",
        skipStep: "تخطى هذه الخطوة وأضف الفروع لاحقاً",
        addBranches: "إضافة فروع",
        yourBranches: "فروعك ({count})",
        moreBranches: "+{count} فروع أخرى",
        manageBranches: "إدارة الفروع",
        benefitsTitle: "فوائد إدارة الفروع",
        benefit1: "العملاء يجدون أقرب موقع لك تلقائياً",
        benefit2: "كل فرع له معلومات اتصال وساعات فريدة",
        benefit3: "تتبع الاستفسارات والأداء حسب الموقع",
        benefit4: "ظهور في المزيد من نتائج البحث المحلية",
      },

      step5: {
        verificationTitle: "التحقق من النشاط مطلوب",
        verificationDesc: "ارفع السجل التجاري للتحقق من شرعية نشاطك",
        whyRequired: "لماذا هذا مطلوب؟",
        reason1: "يضمن إدراج الأنشطة الشرعية فقط على منصتنا",
        reason2: "بناء الثقة مع العملاء المحتملين",
        reason3: "توفير الحماية القانونية والامتثال",
        reason4: "فتح المميزات المتقدمة وترتيب بحث أعلى",
        crLabel: "مستند السجل التجاري",
        uploadCR: "ارفع سجلك التجاري",
        dragDrop: "انقر للتصفح أو اسحب وأفلت مستند السجل التجاري",
        supportedFormats: "الصيغ المدعومة: JPG، PNG، PDF (حد أقصى 5 ميجابايت)",
        replaceFile: "استبدال الملف",
        remove: "إزالة",
        whatNext: "ما الذي سيحدث بعد ذلك؟",
        nextStep1: "ستتم مراجعة مستندك من قبل فريق التحقق",
        nextStep2: "ستتلقى إشعاراً بحالة التحقق",
        nextStep3: "بمجرد الموافقة، سيصبح ملف نشاطك مباشراً",
        verificationTime: "يستغرق التحقق عادةً 1-2 يوم عمل",
        profileSummary: "ملخص الملف التعريفي",
        category: "الفئة",
        type: "النوع",
        services: "الخدمات",
        servicesSelected: "{count} محددة",
        targetCustomers: "العملاء المستهدفون",
        targetCustomersTypes: "{count} أنواع",
        keywords: "الكلمات المفتاحية",
        keywordsAdded: "{count} مضافة",
      },

      buttons: {
        previous: "السابق",
        nextStep: "الخطوة التالية",
        submitting: "جاري إرسال الملف...",
        submit: "إرسال للتحقق",
      },

      modals: {
        successTitle: "تم إكمال الملف!",
        successDesc:
          "ملف نشاطك الآن مكتمل وسيكون مرئياً للعملاء الذين يبحثون في منطقتك.",
        viewListing: "عرض القائمة",
        continueEditing: "متابعة التعديل",
        verificationTitle: "تم إرسال الملف بنجاح!",
        verificationDesc:
          "تم إرسال ملف نشاطك والسجل التجاري للتحقق. سيراجع فريقنا مستنداتك ومعلوماتك خلال 1-2 يوم عمل.",
        whatHappens: "ما الذي سيحدث:",
        verify1: "التحقق من المستندات من قبل فريقنا",
        verify2: "التحقق من صحة معلومات النشاط",
        verify3: "إشعار بالبريد الإلكتروني بحالة الموافقة",
        verify4: "الملف يصبح مباشراً بمجرد التحقق",
      ...
      errors: {
        invalidFile: "يرجى رفع ملف صالح (JPG، PNG، أو PDF)",
        fileSize: "يجب أن يكون حجم الملف أقل من 5 ميجابايت",
      },
    },
